...
осенний;Переработки минерального сырья;6;очная;;ОП-20;I Проектирование обогатительных фабрик;25;Доц. Ромашев А.О.;1;;практика;6307;Уч.ц.1;1.9;31.10;пн;10;.35;12;.05;;;;ос;;;;;;;;;;;;;;;;;
...
function showDatePicker() {
    // Удаляем существующий календарь если он есть
    const existingCalendar = document.getElementById('customDatePicker');
    if (existingCalendar) {
    ...
    calendar.id = 'customDatePicker';
    calendar.className = 'custom-date-picker';
    ...
    function changeMonth(delta) {
        const currentMonthElement = calendar.querySelector('.calendar-month-year');
    ...
    function showMonth(month, year) {
        ...
        for (let i = 0; i < 42; i++) {
            ...
            if (date.getMonth() === month) {
                ...
                if (isSameDay(date, selectedDateObj)) {
    ...
    document.addEventListener('click', function closeCalendar(e) {
        if (!calendar.contains(e.target) && e.target.id !== 'datePickerBtn') {
            calendar.remove();
